...
class HousesTest < ApplicationSystemTestCase
  ...
  test "creating a House" do
    ...
    fill_in "Description en", with: @house.description_en
    fill_in "Description ru", with: @house.description_ru
    fill_in "Owner", with: @house.owner_id
    fill_in "Title en", with: @house.title_en
    fill_in "Title ru", with: @house.title_ru
