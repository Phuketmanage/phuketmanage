...
class TransfersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create transfer" do
    assert_difference('Transfer.count') do
      post transfers_url, params: { transfer: { booking_id: @transfer.booking_id, number: @transfer.number } }
    end
  ...
  test "should update transfer" do
    patch transfer_url(@transfer), params: { transfer: { booking_id: @transfer.booking_id, number: @transfer.number } }
