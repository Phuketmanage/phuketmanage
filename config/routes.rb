Rails.application.routes.draw do
  namespace :guests do
    scope "(:locale)", locale: /en|ru/, defaults: { locale: nil } do
      root to: 'guests/index#index', as: :locale_root
      get :about, to: 'guests/about#index', as: 'page_about'
      get 'search', to: 'guests/search#index'
      resources :houses, only: :show, to: 'guests/houses'
    end
  end

  namespace :admin do
    scope :admin, defaults: { locale: nil } do
