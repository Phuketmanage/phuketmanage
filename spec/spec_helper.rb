...
SimpleCov.start 'rails' do
  ...
  if spec_paths.any?
    root_path = spec_paths.first.partition("/spec").first
    # This code strips out the full path from the file and the file line number. When running the specs for one file
    # and specific line number the full path with not match as it will contain the /users/__USER__/development... part
    ...
    add_filter do |file|
      ...
      file_paths.none? { filename.include?(_1) }
    end
  end
